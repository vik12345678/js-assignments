...
## Javascript Assignments  [![Build Status](https://travis-ci.org/vik12345678/js-assignments.svg?branch=master)](https://travis-ci.org/vik12345678/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'vik12345678'` with your account name).
* Coommit and push updated README.md to github:
```bash
  git add README.md
  git commit -m "Update the links"
  git push origin master
```
* Open https://github.com/vik12345678/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/vik12345678/js-assignments/builds).
